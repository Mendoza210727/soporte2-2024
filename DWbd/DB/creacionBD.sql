...
create table PlanillaSueldos(
    id_PlanillaSueldos INT IDENTITY (1,1) PRIMARY KEY,
    fecha_pago DATE,-- la fecha de pago empesara de acuerdo a la fecha de contratacion del empleado de la tabla empleados
    monto INT -- 
)
create table DetallePlanillaSueldos(
    id_DetallePlanillaSueldos INT IDENTITY(1,1) PRIMARY KEY,
    id_PlanillaSueldos INT,
    id_Empleado INT,
    salario INT,-- es igual al salario de la tabla empleado 
    FOREIGN KEY(id_PlanillaSueldos) REFERENCES PlanillaSueldos(id_PlanillaSueldos),     
...
create table Vuelo(
    ...
    id_NumeroVuelo INT,
    id_TipoVuelo INT,
	escala INT,-- la cantidad de escalas que tendra el vuelo 
	destino INT,
...
create table DetalleReserva(
    ...
    id_Reservas INT,
    PrecioUnitario INT ,--el precio es varia entre 200 y 600
